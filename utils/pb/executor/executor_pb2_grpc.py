...
class ExecutorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Victory = channel.unary_unary(
                '/executor.ExecutorService/Victory',
                request_serializer=executor__pb2.VictoryRequest.SerializeToString,
                response_deserializer=executor__pb2.VictoryResponse.FromString,
                _registered_method=True)
...
def add_ExecutorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Victory': grpc.unary_unary_rpc_method_handler(
                    servicer.Victory,
                    request_deserializer=executor__pb2.VictoryRequest.FromString,
                    response_serializer=executor__pb2.VictoryResponse.SerializeToString,
            ),
    }
...
class ExecutorService(object):
    ...
    def Victory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/executor.ExecutorService/Victory',
            executor__pb2.VictoryRequest.SerializeToString,
            executor__pb2.VictoryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
